...
- **Truthful creator feed:** followed rooms show live/offline state, category, regular schedule text, and an optional next-stream timestamp rendered in the creator-selected IANA timezone.
