...
- The immutable historical baseline is commit `8aa41bf688336c1f8a0a8478e69d556d094477b5` with annotated tag `stream-launch-candidate-0.1.0`. Current private Linux staging runs exact source `e32058df1abc76c08e0bdc041206fa7a98f81c8c`; source, application-image IDs, pre-upgrade backup/restore proof, and the first in-place upgrade are recorded in `Linux-Staging-Deployment-Report.md`.
