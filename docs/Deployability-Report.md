...
- The immutable historical baseline is commit `8aa41bf688336c1f8a0a8478e69d556d094477b5` with annotated tag `stream-launch-candidate-0.1.0`. The current owner-approved application-source candidate is commit `3d0b0ca6198785aded7203043d1a153ec7360c3e`, which adds environment and dependency-supply-chain hardening. It is not yet tagged; application-image digests must still be recorded after an approved staging build so host rollback identifies both source and deployed images.
