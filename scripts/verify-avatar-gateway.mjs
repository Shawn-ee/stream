...
assert.match(thumbnailRoute, /client_max_body_size 640k;/, "live snapshot route must admit the API's 512 KiB frame plus multipart overhead");
...
assert.deepEqual(limits, ["64k", "6m", "640k", "9m"], "only the exact bounded global, avatar, snapshot, and identity limits may be configured");
